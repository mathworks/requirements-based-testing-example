...
copyfile(fullfile(p.RootFolder,'Models',filesep,'TestGenHarnesses', ...
    filesep,'TestCases',filesep,'CruiseControl_TestGen_DisengageWithBrake_.slx'), ...
    fullfile(p.RootFolder,'Work','CruiseControl_TestGen_DisengageWithBrake.slx'));
clear p;
% open the model
open_system('CruiseControl_TestGen_DisengageWithBrake.slx');
