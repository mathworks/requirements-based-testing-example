...
open_system('CruiseControl_RP_Fix');
open_system('CruiseControl_RP_Fix/Compute target speed');
sltest.harness.open('CruiseControl_RP_Fix','CruiseControl_RP_Adhoc_Harness');